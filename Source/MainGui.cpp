...
MainGui::MainGui ()
{
    ...
    juce__textButton->setBounds (96, 64, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="MainGui" componentName=""
  ...
  <TEXTBUTTON name="new button" id="66d2a3a4fcca44ed" memberName="juce__textButton"
              virtualName="" explicitFocusOrder="0" pos="96 64 150 24" buttonText="new button"
